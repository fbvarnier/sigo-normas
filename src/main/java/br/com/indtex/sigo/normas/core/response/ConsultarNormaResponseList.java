...
@Data
@NoArgsConstructor
public class ConsultarNormaResponseList extends DefaultResponse {
    ...
    public ConsultarNormaResponseList(Integer id, String codigo, String nome, String descricao, String area, String tipo, List<Anexo> anexos){
